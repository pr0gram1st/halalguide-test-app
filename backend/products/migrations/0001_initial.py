    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('cash', 'Cash'), ('non-cash', 'Non-Cash'), ('online', 'Online')], max_length=10)),
                ...
                ('items', models.ManyToManyField(related_name='orders', to='products.orderitem')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_supply_date', models.DateField(blank=True, null=True)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='supplier_statistics', to='products.product')),
            ],
        ),
    ]
